...
class PurchaseController extends Controller
{
    ...
    public function datewise(Request $request)
    {
        ...
        $tDis = $tSub - $tPay;
        return view('report::purchase.supplier&datewise',
            compact('suppliers','supplier','purchases','tQty','tSub','tPay','tDis','fromToDate','startDate','endDate'));
    }
    ...
    public function datewise_print(Request $request)
    {
        ...
        $tPay = $purchases->sum('payable');
        $tDis = $tSub - $tPay;
        return view('report::purchase.datewisePrint',
    ...
    public function big_invoice(Request $request)
    {
        ...
        return view('report::purchase.bigInvoice',
    ...
    public function bigInvoicePrint(Request $request)
    {
        ...
        return view('report::purchase.bigInvoicePrint',
            compact('company','purchases','purchase_dt'));
    }
    ...
    public function mini_invoice(Request $request)
    {
        ...
        return view('report::purchase.miniInvoicePrint',
