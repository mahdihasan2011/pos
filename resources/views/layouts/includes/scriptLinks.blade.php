...
<!-- Ekko Lightbox -->
<script src="{{ asset('public/master') }}/plugins/ekko-lightbox/ekko-lightbox.min.js"></script>
<!-- Filterizr-->
<script src="{{ asset('public/master') }}/plugins/filterizr/jquery.filterizr.min.js"></script>
<!-- Tempusdominus Bootstrap 4 -->
<script src="{{ asset('public/master') }}/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js"></script>
<!-- Bootstrap Switch -->
<script src="{{ asset('public/master') }}/plugins/bootstrap-switch/js/bootstrap-switch.min.js"></script>
