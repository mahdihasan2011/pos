<aside class="main-sidebar elevation-4 {{ !empty($settings->sidebar_variant) ? $settings->sidebar_variant :
    ...
    $settings->brand_logo_variant : "" }}">
        <img src="{{ !empty($company->logo) ? asset($company->logo) : asset('public/logo/icon.png') }}"
            alt="{{ !empty($company->title) ? $company->title : config('app.name') }}"
            class="brand-image img-circle elevation-3">
        <span class="brand-text font-weight-light">{{ !empty($company->title) ? $company->title : config('app.name')
            }}</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="{{ !empty(Auth::user()->image) ? asset(Auth::user()->image) : asset('public/master/dist/img/user2-160x160.jpg') }}"
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column {{ !empty($settings->flat_sidebar) ?
                ...
                <li
                    class="nav-item has-treeview {{ ( $controller == 'DashboardController' && $action == 'index' ) ? 'menu-open' : '' }}">
                    <a href="{{ route('dashboard') }}"
                        class="nav-link {{ ( $controller == 'DashboardController' && $action == 'index' ) ? 'active' : '' }}">
                ...
                @can('sale')
                <li
                    class="nav-item has-treeview {{ ( $controller == 'PoSController' && $action == 'pos' ) ? 'menu-open' : '' }}">
                    <a href="#"
                        class="nav-link {{ ( $controller == 'PoSController' && $action == 'pos' ) ? 'active' : '' }}">
                ...
                <li class="nav-item has-treeview {{ ( $controller == 'StockController' ) ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('stock.current') }}"
                                class="nav-link {{ ( $controller == 'StockController' ) ? 'active' : '' }}">
                ...
                @can('purchase')
                <li
                    class="nav-item has-treeview {{ ( $controller == 'PurchaseController' && $action == 'index' ) ? 'menu-open' : '' }}">
                    <a href="#"
                        class="nav-link {{ ( $controller == 'PurchaseController' && $action == 'index' ) ? 'active' : '' }}">
                ...
                <li
                    class="nav-item has-treeview {{ ( $controller == 'ExpenseController' || $controller == 'ExpenseTypeController' ) ? 'menu-open' : '' }}">
                    <a href="#"
                        class="nav-link {{ ( $controller == 'ExpenseController' || $controller == 'ExpenseTypeController' ) ? 'active' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('expense.index') }}"
                                class="nav-link {{ ( $controller == 'ExpenseController' && $action == 'index' ) ? 'active' : '' }}">
                                <i class="fas fa-circle nav-icon"></i>
                                <p>Expenses</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('expense.type.index') }}"
                                class="nav-link {{ ( $controller == 'ExpenseTypeController' && $action == 'index' ) ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Expense Type</p>
                            </a>
                        </li>
                ...
                <li class="nav-item has-treeview {{ ( $controller == 'ProductController' ||
                    ...
                    <ul class="nav nav-treeview">
                        @can('product_create')
                        <li class="nav-item">
                            <a href="{{ route('product.entry') }}"
                                class="nav-link {{ ( $controller == 'ProductController' ) ? 'active' : '' }}">
                        ...
                        <li
                            class="nav-item has-treeview {{ ( $controller == 'CategoryController' || $controller == 'BrandController' || $controller == 'ColorController' || $controller == 'SizeController' ) ? 'menu-open' : '' }}">
                            <a href="#"
                                class="nav-link {{ ( $controller == 'CategoryController' || $controller == 'BrandController' || $controller == 'ColorController' || $controller == 'SizeController' ) ? 'active' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('category.index') }}"
                                        class="nav-link {{ ( $controller == 'CategoryController' ) ? 'active' : '' }}">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('brand.index') }}"
                                        class="nav-link {{ ( $controller == 'BrandController' ) ? 'active' : '' }}">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('color.index') }}"
                                        class="nav-link {{ ( $controller == 'ColorController' ) ? 'active' : '' }}">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('size.index') }}"
                                        class="nav-link {{ ( $controller == 'SizeController' ) ? 'active' : '' }}">
                ...
                <li
                    class="nav-item has-treeview {{ ( $controller == 'RoleController' || $controller ==
                    ...
                    <a href="#"
                        class="nav-link {{ ( $controller == 'RoleController' || $controller ==
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('company.index') }}"
                                class="nav-link {{ ( $controller == 'CompanyController' ) ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('customer.index') }}"
                                class="nav-link {{ ( $controller == 'CustomerController' ) ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('supplier.index') }}"
                                class="nav-link {{ ( $controller == 'SupplierController' ) ? 'active' : '' }}">
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('stock.report.current') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Current</p>
                                    </a>
                                </li>
