...
<title>
    {{ !empty($company->title) ? $company->title : config('app.name') }} | @yield('title')
</title>
<!-- favicon -->
<link rel="shortcut icon" type="image/x-icon"
    href="{{ !empty($company->logo) ? asset($company->logo) : asset('public/logo/icon.png') }}">
<!-- Font Awesome Icons -->
...
<link rel="stylesheet"
    href="{{ asset('public/master') }}/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css">
<!-- Ionicons -->
<link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
<!-- DataTables -->
<link rel="stylesheet" href="{{ asset('public/master') }}/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
<link rel="stylesheet"
    href="{{ asset('public/master') }}/plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
<link rel="stylesheet" href="{{ asset('public/master') }}/dist/css/adminlte.min.css">
...
<link rel="stylesheet"
    href="{{ asset('public/master') }}/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
