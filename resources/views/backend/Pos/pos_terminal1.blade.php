	                ...
	                <form id="CartStore">
	                    <div class="card">
	                            ...
	                            <div class="row">
	                                <div class="col-lg-5 row">
	                                    ...
	                                    <div class="col-lg-6 row">
	                                        <div class="col-lg-4">Sale Date:</div>
	                                        <input type="date" value="{{ $today }}" name="sale_date" 
	                                        	class="col-lg-8 form-control form-control-sm" title="Choose Date"/>
	                                    </div>
	                                </div>
	                                <div class="col-lg-4">
	                        ...
	                        <div class="card-body row">
	                        	<div class="col-lg-3 table-responsive" style="height: 400px;">
	                            ...
	                            <div class="col-lg-6 table-responsive" style="height: 400px;">
	                            	<!-- <div class="input-group input-group-sm">
					                  	<input type="text" class="form-control" autofocus="" placeholder="Search Product Code / Barcode">
	                            ...
	                            <!-- <div class="col-lg-3">
                                    <ul class="navbar-nav float-right">
                                        <li class="form-inline form-group" style="float: right;">
                                            <div class="form-control-sm">Total Quantity : </div>
                                            <div>
                                        ...
                                        <li class="form-inline form-group">
                                            <div class="form-control-sm">SubTotal (‎৳) : </div>
                                            <div>
                                        ...
                                        <li class="form-inline form-group">
                                            <div class="form-control-sm">Discount : </div>
                                            <div class="form-inline">
                                                <input class="text-center DISC col-lg-6 form-control form-control-sm" value="0" name="discount" type="number"required/>
                                                <select class="DISCTYPE col-lg-3 form-control form-control-sm">
                                        ...
                                        <li class="form-inline form-group">
                                            <div class="form-control-sm">Payable Amount (‎৳) : </div>
                                            <div>
                                                <input class="text-right form-control form-control-sm PAY" 
                                                    value="0" name="payable" readonly style="border:hidden;">
                                            </div>
                                        </li>
                                        <li class="form-inline form-group">
                                            <div class="form-control-sm">Paid Amount (‎৳) : </div>
                                            <div>
                                        ...
                                        <li class="form-inline form-group">
                                            <div class="form-control-sm">Due Amount (‎৳) : </div>
                                            <div>
                                                <input class="text-right form-control form-control-sm DUE" 
                                                    value="0" name="due" readonly style="border: hidden;"/>
                                            </div>
                                        </li>
                                        <li class="form-inline form-group">
                                            <div class="form-control-sm">Return Amount (‎৳) : </div>
                                            <div>
	                            ...
	                            <div class="col-lg-3 row">
	                            	<div class="col-lg-6">
	                            		<div class="text-right form-control-sm">Total Quantity : </div>
	                            	</div>
	                            	<div class="col-lg-6">
	                            	...
	                            	<div class="col-lg-6">
	                            		<div class="text-right form-control-sm">SubTotal (‎৳) : </div>
	                            	</div>
	                            	<div class="col-lg-6">
	                            	...
	                            	<div class="col-lg-6">
	                            		<div class="text-right form-control-sm">Discount : </div>
	                            	</div>
	                            	<div class="col-lg-6">
	                            		<div class="form-inline">
	                            	...
	                            	<div class="col-lg-6">
	                            		<div class="text-right form-control-sm">Payable Amount (‎৳) : </div>
	                            	</div>
	                            	<div class="col-lg-6">
	                            	...
	                            	<div class="col-lg-6">
	                            		<div class="text-right form-control-sm">Paid Amount (‎৳) : </div>
	                            	</div>
	                            	<div class="col-lg-6">
	                            		<input class="text-center form-control form-control-sm PAID" 
                                            required value="0" name="paid" type="number"/>
	                            	...
	                            	<div class="col-lg-6">
	                            		<div class="text-right form-control-sm">Due Amount (‎৳) : </div>
	                            	</div>
	                            	<div class="col-lg-6">
	                            	...
	                            	<div class="col-lg-6">
	                            		<div class="text-right form-control-sm">Return Amount (‎৳) : </div>
	                            	</div>
	                            	<div class="col-lg-6">
	                            	...
	                            	<div class="col-lg-6">
	                            		<div class="text-right form-control-sm">Payment Type : </div>
	                            	</div>
	                            	<div class="col-lg-6">
                                        <select class="payment_type form-control form-control-sm" 
                                        	id="pay_type" title="Payment Type">
