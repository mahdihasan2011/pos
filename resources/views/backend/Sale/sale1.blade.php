                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <input type="date" value="{{ $today }}" name="sale_date" class="form-control form-control-sm"/>
{{--                                    <input type="text" id="datepicker" name="sale_date" class="form-control form-control-sm" title="Select Date"/>--}}
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7 row">
                                    ...
                                    <div class="col-lg-4" id="payment_number">
...
@section('customJs')
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $('select[name="addProduct"]').on('select2:select', function(e) {
                var id = $(this).val();
                $.ajax({
                    ...
                    success: function (data) {
                        $('select[name="addProduct"]').val(null).trigger('change');
