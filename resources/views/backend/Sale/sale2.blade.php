	                ...
	                <form id="CartStore">
	                    <div class="card">
	                        <div class="card-body row py-1">
	                        	<div class="col-lg-5 col-5 table-responsive" style="height: 590px;">
	                        		<div class="row d-flex justify-content-around">
                                    @foreach ($products as $data)
                                        <button class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 PRODUCTS rounded mx-auto d-block"
                                            value="{{ $data->id }}" title="{{ $data->name }} - ৳ {{ $data->price }}"
...
{{--	                                            <td class="form-control-sm">{{ $data->id }}.</td>--}}
	                            ...
	                            <div class="col-lg-2 col-2">
                                    ...
                                    <div class="form-inline">
                                        ...
                                        form-control form-control-sm pr-0 pl-1">
                                    ...
                                    <input class="text-center form-control form-control-sm PAID" required value="0"
            ...
            $(document).on('click', 'li', function(){
                ...
                $.ajax({
                    ...
                    success:function (reponse) {
                        ...
                        $('.SUBT').val(reponse.subt.toFixed(2));
                        $('.DISC').val('0');
                    ...
                    if (actionType == "create-customer") {
                        $.ajax({
                            ...
                            success: function (data)
                            {
                                ...
                                $('select[name="customer"]').val(data.id);
                                $('select[name="customer"]').append('<option value="'+data.id+'" selected="selected">'+ data.name +'</option>');
                            },
                            error: function (data) {
