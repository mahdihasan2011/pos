                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-5 row form-group">
                                <select class="col-10 select2bs4 form-control form-control-sm" 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="text-center form-control form-control-sm PAID" 
                                                requir ed value="" name="paid" type="text" style="width: 150px;" />
                                        </td>
                                    </tr>
                                    <tr>
                ...
                $.ajax({
                    ...
                    success: function () {
                        ...
                        $(function() { 
                            Toast.fire({
                            type: 'success',
                            title: ' &nbsp; Product Sales Completed Successfully... '
                            })
                        });
                        setTimeout(function(){
                            location.reload();
