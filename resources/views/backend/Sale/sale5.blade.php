                ...
                <form id="CartStore">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-5 row form-group">
                                    <select class="col-10 select2 bs4 form-control form-control-sm" 
                        ...
                        <div class="card-body row">
                            <div class="col-8 table-responsive row" style="height: 440px;">
                        ...
                        {{-- <div class="card-body text-center">
                            <button type="button" class="btn btn-danger btn-sm CLEAR">Clear Cart</button>
                            <button type="button" class="btn btn-success btn-sm CATSAV">Confirm Sales</button>
                        </div> --}}
                    </div>
                </form>
            </div>
