                ...
                <form id="adD">@csrf
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="name">Color Name <span style="color:gray">*</span></label>
                            <input id="name" class="form-control form-control-sm"
                                type="text" placeholder="Color Name" required>
                        </div>
                        <div class="form-group">
                            <label for="details">Color Code <span style="color:gray">*</span></label>
                            <input id="details" class="form-control form-control-sm"
                                type="number" placeholder="Color Code" required>
                        </div>
                    </div>
