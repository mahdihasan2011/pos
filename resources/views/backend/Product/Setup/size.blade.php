            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Size <small>( List )</small></h3>
                        @can('size_create')
                        <button class="btn btn-primary btn-sm" type="button" style="float:right;"
                            data-toggle="modal" data-target="#add-modal-sm">Add Size
                        </button>
                        @endcan
                    </div>
                    <div class="card-body">
                ...
                <form id="adD">@csrf
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="name">Size Name <span style="color:gray">*</span></label>
                            <input id="name" class="form-control form-control-sm" type="text"
                                placeholder="Size Name" style="text-transform: upper case;" required>
                        </div>
                        <div class="form-group">
                            <label for="details">Size Code <span style="color:gray">*</span></label>
                            <input id="details" class="form-control form-control-sm"
                                type="number" placeholder="Size Code" required>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <form id="updatE">@csrf
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="name">Size Name <span style="color:gray">*</span></label>
                            <input class="form-control form-control-sm name text -uppercase"
                                type="text" placeholder="Size Name" required>
                        </div>
                        <div class="form-group">
                            <label for="details">Size Code <span style="color:gray">*</span></label>
