            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Group <small>( List )</small></h3>
                        <button class="btn btn-primary btn-sm" type="button" style="float:right;"
                            data-toggle="modal" data-target="#add-modal-sm">Add Group
                        </button>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input id="details" class="form-control form-control-sm"
                                type="text" placeholder="Group Details">
                        </div>
                    </div>
