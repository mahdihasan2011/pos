                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="form-inline">
                                            <input class="text-center DISC col-7 form-control 
                                                form-control-sm" value="{{ $disc }}" name="disc" 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="payable">
                                                <input class="text-right form-control form-control-sm 
                                                    PAY" value="{{ $payable }}" name="payable"
                                                    style="border: hidden; width: 150px;" readonly>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="paid">
                                                <input class="text-center form-control form-control-sm
                                                    PAID" value="{{ $paid }}" name="paid" type="number" 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="due">
                                                <input class="text-right form-control form-control-sm
                                                    DUE" value="{{ $due }}" name="due" readonly
                                                    style="border: hidden; width: 150px;"/>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="return">
                                                <input class="text-right form-control form-control-sm 
                                                    RETURN" value="{{ $return }}" name="return" 
                                                    style="border: hidden; width: 150px;" readonly/>
                                            </div>
                                        </td>
                                    </tr>
        ...
        $("#PRODUCT").on('change', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $(".payable").load(location + " .payable");
                    $(".due").load(location + " .due");
                    $(".return").load(location + " .return");
                    const Toast = Swal.mixin({
                        toast: true,
                        position: 'top',
                        showConfirmButton: false,
