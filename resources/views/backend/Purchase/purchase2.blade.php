...
<div class="content-wrapper">
                        ...
                        <div class="row">
                            <div class="col-5 row">
                                <h5 class="col-12 card- title">
                                    Purchase Invoice <b class="blink_me05">:</b> 
                        ...
                        <div class="col-8 table-responsive row p-0 m-0" style="height: 330px;">
                            <table class="add2cart table table-head-fixed pb-0 mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="form-control-sm">{{ $data->sl }}.</td>
                                        <td colspan="2">
                                        ...
                                        <td>
                                            <input class="PRICE form-control form-control-sm" 
                                                value="{{ $data->price }}" name="quantity" 
                            ...
                            <table class="addtwocart table p-0 m-0">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input class="text-center form-control form-control-sm TQTY" readonly 
                                                name="due" value="{{ $tqty }}" 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="text-right form-control form-control-sm SUBT" readonly
                                                name="due" value="{{ $subt }}"
                                                style="border: hidden; width: 150px;"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="form-inline">
                                            ...
                                            <select class="DISCTYPE col-4 form-control form-control-sm" name="disc-type">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="text-right form-control form-control-sm PAY" readonly
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="text-center form-control form-control-sm PAID" 
                                                required name="paid" type="number" style="width: 150px;"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-right form-control-sm">Due Amount (Tk.) : </td>
                                        <td>
                                            <input class="text-right form-control form-control-sm DUE" readonly 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="text-right form-control form-control-sm RETURN" readonly
    ...
    <script type="text/javascript">
        document.getelementsbyclassname("PAY").addEventListener('keyup', function () {
        document.getelementsbyclassname("BILL").innerhtml = document.getelementsbyclassname("PAY").value;
        });
    </script>
    ...
    <script>
        ...
        {{--  $(".addtwocart").window('load', function(doStuff);  --}}
        {{--  $(".addtwocart").load(function(doStuff());  --}}
