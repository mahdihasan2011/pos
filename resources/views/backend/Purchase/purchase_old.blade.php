                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-4 row">
                                <div class="col-10">
                                    <select class="SUPP form-control form-control-sm" name="supplier"
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $(function() { 
                        Toast.fire({
                        type: 'info',
                        title: '&nbsp; Item Price Updated Successfully. '
                        })
                    });
                },
                error: function (data) {
            ...
            $.ajax({
                ...
                error: function (data) {
                    ...
                    $(function() { 
                        Toast.fire({
                        type: 'error',
                        title: '&nbsp; Item Quantity Not Updated. '
                        })
                    });
                }
            });
